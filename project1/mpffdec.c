                            ...
                            AVPacket *avpkt)
{
    ...
    if(messagePrinted == 00){
      printf("*** CS 3505: Executing in bmp_decode_frame in libavcodec/bmp.c ***\r\n");
      printf("*** CS 3505: Modified by John Ballard and Maks Cegielski-Johnson ***\r\n");
      messagePrinted = 1;
    }
